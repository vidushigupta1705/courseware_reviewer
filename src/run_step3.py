...
from deterministic_checks import run_all_checks_step3
...
def process_file(input_file: Path):
    ...
    state = run_all_checks_step3(state)
    ...
    json_path = INTERMEDIATE_JSON_DIR / f"{state.base_filename}_step3_state.json"
