...
from deterministic_checks import run_all_checks_step9
...
def process_file(input_file: Path, resume=True):
    ...
    if current_stage == "accuracy_done":
        state = run_all_checks_step9(state)
    ...
    json_path = INTERMEDIATE_JSON_DIR / f"{state.base_filename}_step9_state.json"
