# courseware_review_system/src/run_step1.py
...
from deterministic_checks import run_all_step1_checks
...
def process_file(input_file: Path):
    ...
    state = run_all_step1_checks(state)
    ...
    json_path = INTERMEDIATE_JSON_DIR / f"{state.base_filename}_step1_state.json"
